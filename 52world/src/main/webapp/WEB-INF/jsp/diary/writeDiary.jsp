...
<div class="middle-container">
	...
	<div class="middle-box">
		<div id="mybox">
			<div id="diaryMenu">
				<h3> ${member.name }님 오늘의 하루 어떠셨나요? :)</h3>
			</div>
			...
			<div class="diary_post_box">
				...
				<div class="diary_post">
					...
					<div class="diary_container">
						<form action="${pageContext.request.contextPath }/writeDiary.do"
							method="post" class="insert-box" id="write" name="write">

							<input type="hidden" name="homepee_id" value="${member.id }">
							<input type="hidden" name="writer" value="${member.id }">

							<p class="left_tab">제목 ▽</p>
							<input class="right_title" type="text" name="title"
								style="width: 610px; height: 30px"><br>
							<br>

							<p class="left_tab">내용 ▽</p>
							<textarea class="right_content" name="content" cols="30"
								rows="10" style="width: 610px;"></textarea>

							<br> <input type="button" value="등록"
								style="padding: 10px; float: right; margin: 20px; width: 100px" onclick="writeDiary()">
		
			
								<!-- document.querySelecotr = ~~~.submit()이거릃 함수로 바꾸고 온클릭하면 함수실행, 알랏창 띄우고, 서브밋 함수-->
